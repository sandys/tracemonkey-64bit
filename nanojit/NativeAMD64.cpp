...
#if defined FEATURE_NANOJIT && defined NANOJIT_64BIT
...
namespace nanojit
{
    ...
    static void todo(const char *s) {
     //   verbose_only( outputf("%s",s); )
        //sss verbose_only( avmplus::AvmLog("%s",s); )
...
/*    //sss NIns* Assembler::asm_adjustBranch(NIns*, NIns*) {
    NIns* Assembler::nPatchBranch(NIns*, NIns*) {
...
*/
    ...
    void Assembler::underrunProtect(long bytes) {
        ...
        //sss added by looking at the i386 code and the redux 64-bit code
        NIns *pc = _nIns;
